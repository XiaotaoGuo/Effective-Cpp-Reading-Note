...
|21|[必须返回对象时，不要试图返回其引用](https://github.com/XiaotaoGuo/Effective-Cpp-Reading-Note/blob/master/4.DesignsAndDeclarations/21.DontTryToReturnAReferenceWhenYouMustReturnAnObject.md)|[code20](https://github.com/XiaotaoGuo/Effective-Cpp-Reading-Note/tree/master/PracticeCode/21.DontTryToReturnAReferenceWhenYouMustReturnAnObject)|
||**实现**||
||**继承与面向对象设计**||
||**模板与泛型编程**||
||**定制 new 和 delete**||
